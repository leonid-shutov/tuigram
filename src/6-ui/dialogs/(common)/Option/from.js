...
({ chatId, name, lastMessage, unreadCount = 0, isUnread = false, isMuted = false }) => {
  ...
  // Inner text width of the dialogs list: the wrapper box is config.panelWidth wide in
  // 3-component.js, minus borders and left/right gaps.
  const width = config.panelWidth - 4;
